...
import { Avatar, AvatarGroup } from '@/components/tds/Avatar'
  ...
  return (
    <div className="flex gap-8">
      <article className="flex-1 max-w-3xl px-8 py-10">
        ...
        <h1 className="text-4xl font-bold text-[var(--tds-color-text-primary)] mb-3">Avatar</h1>
        ...
        <section id="fallback" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--tds-color-text-primary)] mb-4">이니셜 폴백</h2>
        ...
        <section id="placeholder" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--tds-color-text-primary)] mb-4">플레이스홀더</h2>
        ...
        <section id="shape" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--tds-color-text-primary)] mb-4">Shape</h2>
        ...
        <section id="group" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--tds-color-text-primary)] mb-4">AvatarGroup</h2>
          <p className="text-sm text-[var(--tds-color-text-secondary)] mb-4">
        ...
        <section id="props" className="mt-10">
          ...
          <h3 className="text-base font-semibold text-[var(--tds-color-text-primary)] mb-3">Avatar</h3>
          <PropsTable
            props={[
          ...
          />
          <h3 className="text-base font-semibold text-[var(--tds-color-text-primary)] mb-3 mt-6">AvatarGroup</h3>
          <PropsTable
            props={[
        ...
        <section id="code" className="mt-10">
          ...
          <CodeBlock
            code={`import { Avatar, AvatarGroup } from '@/components/tds'
