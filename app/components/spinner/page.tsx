  ...
  return (
    <div className="flex gap-8">
      <article className="flex-1 max-w-3xl px-8 py-10">
        ...
        <h1 className="text-4xl font-bold text-[var(--tds-color-text-primary)] mb-3">Spinner</h1>
        ...
        <section id="sizes" className="mt-10">
          ...
          <div className="space-y-2 mt-3 text-sm text-[var(--tds-color-text-secondary)]">
        ...
        <section id="variants" className="mt-10">
          ...
          <ComponentPreview label="white (어두운 배경)">
            <div className="bg-[var(--tds-color-primary)] p-8 rounded-xl flex items-center justify-center w-full">
              <Spinner variant="white" />
            </div>
          </ComponentPreview>
          <ComponentPreview label="current (부모 색상 상속)">
            <div className="text-[var(--tds-color-success)] flex items-center gap-2">
        ...
        <section id="code" className="mt-10">
          ...
          <CodeBlock
            code={`import { Spinner } from '@/components/tds'
