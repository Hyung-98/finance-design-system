...
import { Divider } from '@/components/fds/Divider'
  ...
  return (
    <div className="flex gap-8">
      <article className="flex-1 max-w-3xl px-8 py-10">
        ...
        <h1 className="text-4xl font-bold text-[var(--fds-color-text-primary)] mb-3">Divider</h1>
        ...
        <section id="horizontal">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">수평 구분선</h2>
          <ComponentPreview label="solid / dashed">
            <div className="w-full space-y-6">
              <div>
                <p className="text-sm text-[var(--fds-color-text-secondary)] mb-3">위 섹션</p>
                <Divider />
                <p className="text-sm text-[var(--fds-color-text-secondary)] mt-3">아래 섹션</p>
              </div>
              <div>
                <p className="text-sm text-[var(--fds-color-text-secondary)] mb-3">dashed 스타일</p>
        ...
        <section id="with-label" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">레이블 구분선</h2>
        ...
        <section id="vertical" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">수직 구분선</h2>
          <ComponentPreview label="인라인 요소 사이">
            <div className="flex items-center gap-4 text-sm text-[var(--fds-color-text-secondary)]">
              <span>송금</span>
        ...
        <section id="spacing" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">Spacing</h2>
          <ComponentPreview label="none / sm / md / lg">
            <div className="w-full">
              {(['none', 'sm', 'md', 'lg'] as const).map((s) => (
                <div key={s} className="flex items-center gap-3 mb-2">
                  <span className="text-xs text-[var(--fds-color-text-tertiary)] w-8">{s}</span>
        ...
        <section id="code" className="mt-10">
          ...
          <CodeBlock
            code={`import { Divider } from '@/components/fds'
