...
import { Tooltip } from '@/components/fds/Tooltip'
  ...
  return (
    <div className="flex gap-8">
      <article className="flex-1 max-w-3xl px-8 py-10">
        ...
        <h1 className="text-4xl font-bold text-[var(--fds-color-text-primary)] mb-3">Tooltip</h1>
        ...
        <section id="placement">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">Placement</h2>
        ...
        <section id="usage" className="mt-10">
          ...
          <ComponentPreview label="아이콘 버튼 레이블">
            <div className="flex gap-3">
              <Tooltip content="설정">
                <button className="p-2 rounded-lg hover:bg-[var(--fds-color-bg-elevated)] transition-colors" aria-label="설정">
                  <svg className="w-5 h-5 text-[var(--fds-color-text-secondary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
              ...
              <Tooltip content="알림">
                <button className="p-2 rounded-lg hover:bg-[var(--fds-color-bg-elevated)] transition-colors" aria-label="알림">
                  <svg className="w-5 h-5 text-[var(--fds-color-text-secondary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
              ...
              <Tooltip content="공유하기">
                <button className="p-2 rounded-lg hover:bg-[var(--fds-color-bg-elevated)] transition-colors" aria-label="공유하기">
                  <svg className="w-5 h-5 text-[var(--fds-color-text-secondary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
          ...
          <ComponentPreview label="약어 설명">
            <p className="text-sm text-[var(--fds-color-text-secondary)]">
              현재{' '}
              <Tooltip content="연간 수익률 (Annual Percentage Yield)" placement="top">
                <span className="underline decoration-dashed cursor-help text-[var(--fds-color-text-primary)] font-medium">APY</span>
              </Tooltip>
              는 <strong className="text-[var(--fds-color-text-primary)]">3.5%</strong>입니다.
            </p>
          </ComponentPreview>
        </section>
        ...
        <section id="code" className="mt-10">
          ...
          <CodeBlock
            code={`import { Tooltip } from '@/components/fds'
