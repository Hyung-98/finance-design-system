...
import { Chip, ChipGroup } from '@/components/fds/Chip'
  ...
  return (
    <div className="flex gap-8">
      <article className="flex-1 max-w-3xl px-8 py-10">
        ...
        <h1 className="text-4xl font-bold text-[var(--fds-color-text-primary)] mb-3">Chip</h1>
        ...
        <section id="filter">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">Filter Chip</h2>
        ...
        <section id="tag" className="mt-10">
          <h2 className="text-2xl font-bold text-[var(--fds-color-text-primary)] mb-4">Tag Chip</h2>
          <p className="text-sm text-[var(--fds-color-text-secondary)] mb-4">
        ...
        <section id="props" className="mt-10">
          ...
          <h3 className="text-base font-semibold text-[var(--fds-color-text-primary)] mb-3">Chip</h3>
          <PropsTable
            props={[
          ...
          />
          <h3 className="text-base font-semibold text-[var(--fds-color-text-primary)] mb-3 mt-6">ChipGroup</h3>
          <PropsTable
            props={[
        ...
        <section id="code" className="mt-10">
          ...
          <CodeBlock
            code={`import { Chip, ChipGroup } from '@/components/fds'
import { useState } from 'react'
